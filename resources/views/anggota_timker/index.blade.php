        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="border:1px solid #ccc; padding:0.5rem;">
                    <a href="{{ route('anggota_timker.show', $pengajuan->id) }}" style="background:#3490dc; color:white; padding:0.3rem 0.6rem; border-radius:4px; text-decoration:none;">Lihat Detail</a>
                </td>
            </tr>
            @endforeach
        </tbody>
